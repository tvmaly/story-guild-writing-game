...
const legal: Readonly<Record<AppPhase, readonly AppPhase[]>> = {
  ...
  onboarding: ['hub'],
  resumePrompt: ['hub', 'questBriefing', 'explore', 'puzzle', 'reflection', 'writing', 'review', 'celebration', 'copy', 'complete'],
  hub: ['questBriefing', 'explore', 'puzzle', 'reflection', 'writing', 'review', 'celebration', 'copy', 'complete', 'parent'],
  questBriefing: ['explore', 'hub'],
  explore: ['puzzle', 'reflection', 'hub'],
  puzzle: ['explore', 'reflection', 'writing', 'hub'],
  reflection: ['writing', 'hub'],
  writing: ['review', 'hub'],
  review: ['writing', 'celebration', 'copy', 'hub'],
  celebration: ['copy', 'writing', 'hub'],
